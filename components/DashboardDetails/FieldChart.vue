...
import {
  Chart as ChartJS,
  Filler, Title, Tooltip, Legend, LineElement, PointElement,
...
<template>
  <div class="bg-white rounded-xl shadow p-4 border border-sky-100">
    ...
    <div v-if="!ndviChart.length" class="text-sm text-gray-400">
      Failed to load NDVI data or no data available.
    </div>
